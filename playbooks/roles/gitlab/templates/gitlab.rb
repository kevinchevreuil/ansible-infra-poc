...
external_url 'https://gitlab.exo-industries.xyz'
...
nginx['ssl_certificate'] = "/etc/gitlab/ssl/gitlab.exo-industries.xyz.crt"
nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/gitlab.exo-industries.xyz.key"
